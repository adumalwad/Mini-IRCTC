		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="nav-item active">
					<a class="nav-link" href="#"><b>Cancelled Tickets</b></a>
				</li>
           	</ul>
		...
		<div class="table table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							<h2>Cancelled Ticket Details</h2>
						</div>
						<div class="col-xs-6">
				...
				<table class="table table-striped table-hover text-center table-bordered" id="myTable">
					...
					<tbody>
						<?php
							...
							$query="SELECT * FROM reservation,cancel_ticket where ticket_status='CANCELLED' AND reservation.pnr_number=cancel_ticket.pnr_number";
							...
							while ($row=mysqli_fetch_array($result))
							{
								echo "<tr>
										...
										<td>
                        					...
                        					<a href=\"http://localhost/railway/passenger_info_2.php?pnr_no=".$row[0]."\">
